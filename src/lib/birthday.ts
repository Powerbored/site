...
/** Resolve a theme by ID, falling back to neon. */
export function getTheme(id: string): Theme {
    return themes[id as ThemeId] ?? themes.neon;
}

/** Resolve a message by index, falling back to index 0. */
export function getMessage(index: number): string {
